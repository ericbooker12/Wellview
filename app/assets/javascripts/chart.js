...
//   lineData = getLine(colData.lineData)

//   function getLine(lineData) {
//   switch (lineData) {
//     case "tempOut":
...
//       var lineData = d3.svg.line()
//         .x(function(d) { return xScale(d.temp_in); })
//         .y(function(d) { return yScale(d.depth);    })
//         .interpolate("basis")
//         return lineData;
//       break;
...
//       var lineData = d3.svg.line()
//         .x(function(d) { return xScale(d.pressure); })
//         .y(function(d) { return yScale(d.depth);    })
//         .interpolate("basis")
//         return lineData;
//       break;
...
//       var lineData = d3.svg.line()
//         .x(function(d) { return xScale(d.rop); })
//         .y(function(d) { return yScale(d.depth);    })
//         .interpolate("basis")
//         return lineData;
//       break;
...
//       var lineData = d3.svg.line()
//         .x(function(d) { return xScale(d.wob); })
//         .y(function(d) { return yScale(d.depth); })
//         .interpolate("basis")
//         return lineData;
//       break;  
...
// function setUpCanvas(columnId, width) {
//   d3.select("#chart_container")
//     .append("svg")
//       .attr('id', columnId)
//       .attr("width", width)
